...
<html lang="en">
  ...
  <head>
    ...
    <title>HP Hotel - Restaurant </title>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="phone">
                                    ...
                                    <h4>Phone Numbers</h4>
                                    <span><a href="#">7038761177</a><br><a href="#">7057032697</a></span>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="message">
                                    ...
                                    <h4>Emails</h4>
                                    <span><a href="#">hphotels@gmail.com</a><br><a href="#">hphotels@hp.com</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
                             ...
                             if($count>0){
                                 ...
                                 <div class='card-body'>
                                     <div class='row'>
                                         ...
                                         <div class='col-md-2 text-centetr'><h5><div class='btn btn-outline-danger' eid ='$email' id='email' >Cancel</div></h5></div>
                                ...
                                echo "<script type='text/javascript'>
                                   window.location.href = 'http://localhost/hphotel/index.php';
                                 </script>";
                             }
                         }
